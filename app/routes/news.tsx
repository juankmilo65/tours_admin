...
const mockNews: readonly NewsItem[] = [
  {
    id: 1,
    title: 'New Tour Launch in Madrid',
...
export default function News(): JSX.Element {
  ...
  return (
    <div className="space-y-6">
      <Card title="All News" actions={<Button variant="primary">Create New Article</Button>}>
